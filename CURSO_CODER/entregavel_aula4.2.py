...
def alerta(nivel, base, etapa):
    ...
    niveis = {1:'DANGER...Alerta Baixo', 2:'DANGER...Alerta Médio', 3:'DANGER...Alerta Alto'}

    titulo = niveis.get(nivel, 'Alerta desconhecido')
...
alerta(nivel = int(input('Digite o nível do alerta(1,2 ou 3):')),
        base = 'CLIENTES', 
        etapa = 'EXTRAÇÃO')
